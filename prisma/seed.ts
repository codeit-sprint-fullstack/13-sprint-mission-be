...
const randomProducts = (): Prisma.ProductCreateManyInput[] => {
...
const randomArticles = (): Prisma.ArticleCreateManyInput[] => {
...
const randomArticleComments = (
  articleIds: { id: number }[],
): Prisma.ArticleCommentCreateManyInput[] => {
  const comments: Prisma.ArticleCommentCreateManyInput[] = [];
...
const randomProductComments = (
  productIds: { id: number }[],
): Prisma.ProductCommentCreateManyInput[] => {
  const comments: Prisma.ProductCommentCreateManyInput[] = [];
