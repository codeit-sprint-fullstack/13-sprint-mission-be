...
export class AuthTokenManager {
    ...
    static getRequesterFromToken(authorizationHeaderValue) {
        ...
        const jwtPayload = jwt.verify(jwtToken, process.env.JWT_ACCESS_TOKEN_SECRET);
    ...
    static getRequesterFromRefreshToken(refreshToken) {
        const jwtPayload = jwt.verify(refreshToken, process.env.JWT_REFRESH_TOKEN_SECRET);
