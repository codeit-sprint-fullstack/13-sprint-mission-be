...
import type { Requester, UpdateProductRequest } from '../../types/application.js';

export class UpdateProductHandler {
    static async handle(requester: Requester, { productId, name, description, price, tags, images }: UpdateProductRequest) {
