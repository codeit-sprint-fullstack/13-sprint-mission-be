...
import type { CreateProductCommentRequest, Requester } from '../../types/application.js';

export class CreateProductCommentHandler {
    static async handle(requester: Requester, { productId, content }: CreateProductCommentRequest) {
