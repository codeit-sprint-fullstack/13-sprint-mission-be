...
import type { RefreshTokenRequest } from '../../types/application.js';

export class RefreshTokenHandler {
    static async handle({ refreshToken }: RefreshTokenRequest) {
        ...
        const requester = AuthTokenManager.getRequesterFromRefreshToken(refreshToken);
