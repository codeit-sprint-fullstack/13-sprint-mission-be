...
import type { CreateArticleCommentRequest, Requester } from '../../types/application.js';

export class CreateArticleCommentHandler {
    static async handle(requester: Requester, { articleId, content }: CreateArticleCommentRequest) {
        /**
         * [게시글 댓글 등록 트랜잭션]
         *
         * 1. 게시글이 존재하는지 확인합니다.
