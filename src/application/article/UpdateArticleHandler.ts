...
import type { Requester, UpdateArticleRequest } from '../../types/application.js';

export class UpdateArticleHandler {
    static async handle(requester: Requester, { articleId, title, content, image }: UpdateArticleRequest) {
        /**
         * [게시글 수정 트랜잭션]
         *
