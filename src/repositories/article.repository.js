...
async function toggleLike({ hasLikedArticle, ownerId, articleId }) {
  if (!hasLikedArticle) {
...
async function findLikedArticleById({ ownerId, articleId }) {
...
async function findLikedArticleIds({ ownerId, articleIds }) {
